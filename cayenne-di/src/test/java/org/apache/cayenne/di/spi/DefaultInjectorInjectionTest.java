...
specifier|public
name|void
name|testListInjection_Instance_addOverrideValueOrdering
parameter_list|()
block|{
name|Integer
name|i
...
argument_list|)
decl_stmt|;
comment|// instance is inserted multiple types, as each instance is treated as a standalone DI Key
name|DefaultInjector
name|i1
init|=
operator|new
...
specifier|public
name|void
name|testListInjection_Type_addOverrideValueOrdering
parameter_list|()
block|{
name|Module
name|m1
