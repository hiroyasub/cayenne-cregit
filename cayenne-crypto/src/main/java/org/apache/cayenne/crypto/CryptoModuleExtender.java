...
return|;
block|}
comment|/**      * Get a name of the provided Java type.      * Consistent with the logic of {@link org.apache.cayenne.di.AdhocObjectFactory#getJavaClass(String)} method      * @param objectType to get a name of      * @return a name of the type      * @param<T> the type of the class      */
specifier|static
parameter_list|<
name|T
parameter_list|>
