...
return|;
block|}
comment|/** 	 * Performs database reverse engineering and generates DataMap that contains 	 * default mapping of the tables and views. By default will include regular 	 * tables and views. 	 * 	 * @since 1.0.7 	 * @deprecated since 4.0 use 	 *             {@link #load(DataMap, DbLoaderConfiguration)} 	 *             method that supports catalogs. 	 */
annotation|@
name|Deprecated
specifier|public
name|DataMap
...
return|;
block|}
comment|/** 	 * Performs database reverse engineering and generates DataMap object that 	 * contains default mapping of the tables and views. Allows to limit types 	 * of tables to read. 	 * 	 * @deprecated since 4.0 use 	 *             {@link #load(DataMap, DbLoaderConfiguration)} 	 *             method that supports catalogs. 	 */
annotation|@
name|Deprecated
specifier|public
name|DataMap
