...
argument_list|()
decl_stmt|;
comment|/**      * Type conversion for the most spread DB data types that are out of the standard      */
specifier|private
specifier|static
specifier|final
name|Map
...
name|String
argument_list|>
name|SQL_ADDITIONAL_TYPES_TO_JAVA_TYPE
init|=
operator|new
name|HashMap
argument_list|<>
...
return|;
block|}
comment|// Check additional common DB types, like 'json' or 'geometry'
if|if
condition|(
name|dbAttribute
operator|instanceof
...
argument_list|)
decl_stmt|;
comment|// use primitive types for non nullable attributes
if|if
condition|(
name|primitiveType
operator|!=
...
argument_list|()
decl_stmt|;
comment|// attribute can be null, see DbJoin.getSource() and DbJoin.getTarget()
if|if
condition|(
name|attr1
operator|==
...
return|;
block|}
comment|// name is unlikely to be null, but we don't want NPE anyway
if|if
condition|(
name|attr1
operator|.
