...
begin_comment
comment|/**  * Wraps an algorithm to traverse a {@link DataMap} and create a group of {@link MergerToken}s that can be used to  * synchronize data store and Cayenne model.  * @deprecated  */
end_comment
