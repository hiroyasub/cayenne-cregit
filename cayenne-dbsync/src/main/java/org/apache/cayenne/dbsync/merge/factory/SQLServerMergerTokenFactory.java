...
argument_list|(
literal|"Can't automatically alter column to IDENTITY in SQLServer database. You should do this manually."
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"Can't automatically alter column to drop IDENTITY in SQLServer database. You should do this manually."
argument_list|)
throw|;
block|}
annotation|@
