...
argument_list|(
literal|"Can't automatically alter column to identity. You need to manually alter schema."
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"Can't automatically drop identity. You need to manually alter schema."
argument_list|)
throw|;
block|}
annotation|@
