...
argument_list|)
expr_stmt|;
name|testCreateAddRelationshipToModel
argument_list|(
name|factory
argument_list|()
operator|.
...
argument_list|)
expr_stmt|;
name|testCreateDropRelationshipToDb
argument_list|(
name|factory
argument_list|()
operator|.
...
specifier|private
name|void
name|testReversTokenWithCount
parameter_list|(
name|MergerToken
name|token
parameter_list|,
name|int
name|countFirstReverse
parameter_list|,
name|int
name|countSecondReverse
parameter_list|)
block|{
name|Collection
argument_list|<
