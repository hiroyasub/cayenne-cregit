...
specifier|public
name|void
name|emptyDbTaskWithDependency
parameter_list|()
throws|throws
name|Exception
block|{
...
name|sqlFile
decl_stmt|;
comment|// Try to open connection, it may fail at first time, so ignore it
try|try
init|(
name|Connection
name|unused
