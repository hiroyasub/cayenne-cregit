...
block|}
block|}
comment|/**      * Creates and returns a new child ObjectContext.      *       * @since 3.0      * @deprecated Since 3.1 replaced by {@link CayenneRuntime#getContext(DataChannel)}      */
annotation|@
name|Deprecated
specifier|public
name|ObjectContext
...
argument_list|)
decl_stmt|;
comment|// TODO: This method should be deprecated and child context should be created via
comment|// DI with all proper injection, so won't have to guess how to handle query cache.
if|if
condition|(
name|queryCache
operator|!=
...
return|;
block|}
comment|/**      * Creates a DataObject from DataRow.      *       * @deprecated Use objectFromDataRow(Class<T> objectClass, DataRow dataRow) instead.      * @see DataRow      */
annotation|@
name|Deprecated
specifier|public
parameter_list|<
...
return|;
block|}
comment|/**      * Creates a DataObject from DataRow. This variety of the 'objectFromDataRow' method      * is normally used for generic classes.      *       * @deprecated Use objectFromDataRow(String entityName, DataRow dataRow) instead.      * @see DataRow      * @since 3.0      */
annotation|@
name|Deprecated
specifier|public
name|DataObject
