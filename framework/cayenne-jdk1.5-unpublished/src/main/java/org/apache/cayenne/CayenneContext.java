...
expr_stmt|;
block|}
comment|/**      * Returns {@link QueryCache}, creating it on the fly if needed.      *       * @since 3.0      */
name|QueryCache
name|getQueryCache
parameter_list|()
block|{
...
return|;
block|}
comment|// TODO: Andrus, 2/2/2006 - make public once CayenneContext is officially declared to
comment|// support DataChannel API.
name|QueryResponse
name|onQuery
parameter_list|(
name|ObjectContext
