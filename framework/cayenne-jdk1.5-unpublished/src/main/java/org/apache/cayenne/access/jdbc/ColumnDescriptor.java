...
block|{
block|}
comment|/**      * Creates a column descriptor with user-specified parameters.      *       * @since 1.2      */
specifier|public
name|ColumnDescriptor
parameter_list|(
name|String
...
return|;
block|}
comment|/**      * Returns a default Java class for an internal JDBC type.      *       * @since 1.2      */
specifier|public
name|String
name|getDefaultJavaClass
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Returns "label" used in a DataRow for column value.      *       * @since 1.2      */
specifier|public
name|String
name|getLabel
parameter_list|()
