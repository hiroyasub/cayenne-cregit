...
return|;
block|}
comment|/**      * @deprecated since 3.1 in favor of {@link #stripLineBreaks(String, char)}.      * @since 1.2      */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
block|}
block|}
comment|/**      * Returns constant field value by fully qualified path.      *       * @return Field value or {@code null} if class or field specified in path was not      *         found.      * @since 3.1      */
specifier|public
specifier|static
name|Object
