...
name|NullPointerException
argument_list|(
literal|"'relationship' can't be null."
argument_list|)
throw|;
block|}
name|this
...
return|;
block|}
comment|/**      * Returns a name of relationship for this list.      *       * @since 1.1      */
specifier|public
name|String
