...
begin_comment
comment|// TODO: andrus, 7/16/2006 - upgrade handler is rather primitive and relies on individual
end_comment

begin_comment
comment|// loaders to be able to read older versions and convert them to the latest one in memory.
end_comment

begin_comment
comment|// So this handler simply checks the version to trigger the update in the calling UI, and
end_comment

begin_comment
comment|// saves what's been already loaded.
end_comment
