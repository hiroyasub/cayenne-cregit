...
return|;
block|}
comment|/**      * Closes all data nodes, removes them from the list of available nodes.      *       * @deprecated since 3.1 unused and unneeded      */
annotation|@
name|Deprecated
specifier|public
name|void
...
block|}
block|}
comment|/**      * Clears the list of internal DataMaps.      *       * @deprecated since 3.1 unused and unneeded      */
annotation|@
name|Deprecated
specifier|public
name|void
...
block|}
block|}
comment|/**      * Creates and returns a new DataContext. If this DataDomain is configured to use      * shared cache, returned DataContext will use shared cache as well. Otherwise a new      * instance of DataRowStore will be used as its local cache.      *       * @deprecated since 3.1 as context creation is done via {@link ObjectContextFactory}      *             and injection.      */
annotation|@
name|Deprecated
specifier|public
name|DataContext
...
return|;
block|}
comment|/**      * Creates a new DataContext.      *       * @param useSharedCache determines whether resulting DataContext should use shared      *            vs. local cache. This setting overrides default behavior configured for      *            this DataDomain via {@link #SHARED_CACHE_ENABLED_PROPERTY}.      * @since 1.1      * @deprecated since 3.1 as context creation is done via {@link ObjectContextFactory}      *             and injection.      */
annotation|@
name|Deprecated
specifier|public
name|DataContext
...
return|;
block|}
comment|/**      * Updates internal index of DataNodes stored by the entity name.      *       * @deprecated since 3.1 - unneeded and unused.      */
annotation|@
name|Deprecated
specifier|public
name|void
...
parameter_list|()
block|{
comment|// filters are ordered innermost to outermost
name|i
operator|--
expr_stmt|;
return|return
...
argument_list|(
literal|"It is illegal to call 'onSync' inside 'onQuery' chain"
argument_list|)
throw|;
block|}
block|}
...
name|UnsupportedOperationException
argument_list|(
literal|"It is illegal to call 'onQuery' inside 'onSync' chain"
argument_list|)
throw|;
block|}
block|}
