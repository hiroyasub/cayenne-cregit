...
expr_stmt|;
block|}
comment|/**      * Returns a collection of all available unit descriptor URLs. Unit descriptors      * (usually cayenne.xml files) are looked up using the internal resource locator.      *       * @since 3.0      */
specifier|protected
name|Collection
argument_list|<
name|URL
argument_list|>
name|getUnitDescriptors
parameter_list|()
block|{
return|return
name|resourceFinder
