...
init|=
literal|"dotemplates/v1_2/embeddable-singleclass.vm"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
init|=
literal|"dotemplates/v1_2/embeddable-subclass.vm"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
init|=
literal|"dotemplates/v1_2/embeddable-superclass.vm"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
condition|)
block|{
comment|// TODO: andrus 12/9/2007 - should we run at least once if there are
comment|// no artifacts? Current behavior is copied from the legacy code.
break|break;
block|}
block|}
block|}
...
expr_stmt|;
block|}
comment|/**      * Opens a Writer to write generated output. Writer encoding is determined from the      * value of the "encoding" property. Output file is determined from the current state      * of VelocityContext and the TemplateType passed as a parameter.      */
specifier|protected
name|Writer
name|openWriter
parameter_list|(
