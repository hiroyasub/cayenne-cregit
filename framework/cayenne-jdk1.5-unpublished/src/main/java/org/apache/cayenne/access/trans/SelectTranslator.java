...
expr_stmt|;
block|}
comment|/**      * Stores a new relationship in an internal list. Later it will be used to create      * joins to relationship destination table.      *       * @deprecated since 3.0 as super is deprecated.      */
annotation|@
name|Override
specifier|public
name|void
