...
begin_comment
comment|/**  * Defines bean property API used by Cayenne to access object data, do faulting and graph  * maintenance tasks.  *   * @since 1.2  *   * @deprecated renamed to PropertyDescriptor in 3.2  *   */
end_comment
