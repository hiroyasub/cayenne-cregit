...
argument_list|)
expr_stmt|;
comment|// the cache for this entity has changed, so re-fetch it then update
name|Queue
argument_list|<
name|Long
argument_list|>
name|previousPlusNext
init|=
operator|new
name|ConcurrentLinkedQueue
argument_list|<
...
argument_list|(
literal|"Unable to add new primary keys to the cache for entity "
operator|+
name|entity
operator|.
name|getName
