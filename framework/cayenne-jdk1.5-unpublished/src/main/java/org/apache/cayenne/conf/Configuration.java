...
comment|// noop
block|}
comment|/**      * Returns the resource locator used for finding and loading resources.      *       * @deprecated since 3.0 use/override {@link #getResourceFinder()}.      */
specifier|protected
name|ResourceLocator
...
argument_list|(
literal|"ResourceFinder is not a ResourceLocator: "
operator|+
name|finder
argument_list|)
throw|;
...
block|}
block|}
comment|/**      * See 'https://svn.apache.org/repos/asf/cayenne/dataviews/trunk' for DataViews code,      * which is not a part of Cayenne since 3.0.      *       * @deprecated since 3.0 as Cayenne no longer cares to read view config files.      */
specifier|protected
name|InputStream
