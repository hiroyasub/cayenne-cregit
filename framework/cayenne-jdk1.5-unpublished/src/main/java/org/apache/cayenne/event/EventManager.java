...
block|}
block|}
comment|/**      * Stops event threads. After the EventManager is stopped, it can not be restarted and      * should be discarded. Note that dispatch threads may still run for a few more minutes      * after this method call until they time out.      *       * @since 3.0      */
specifier|public
name|void
name|shutdown
parameter_list|()
...
block|}
block|}
comment|/**      * Unregister the specified listener from all event subjects handled by this      *<code>EventManager</code> instance.      *       * @param listener the object to be unregistered      * @return<code>true</code> if<code>listener</code> could be removed for any      *         existing subjects, else returns<code>false</code>.      */
specifier|public
name|boolean
name|removeListener
parameter_list|(
