...
argument_list|(
literal|"EntityNonUnionTreeSegmentBuilder should only be used when inheritance is involved."
argument_list|)
throw|;
block|}
name|appendColumns
...
argument_list|)
expr_stmt|;
comment|// TODO: this row reader has incorrect offset and doesn't take into account
comment|// superclass columns
name|entityReaders
operator|.
name|add
argument_list|(
