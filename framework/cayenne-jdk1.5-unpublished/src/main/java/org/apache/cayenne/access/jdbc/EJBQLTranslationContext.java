...
block|{
comment|// Check for vertical inheritance relationships
name|ClassDescriptor
name|descriptor
init|=
name|compiledExpression
...
argument_list|()
decl_stmt|;
comment|// Iterate over entity declared attributes, check for flattened attributes
for|for
control|(
name|ObjAttribute
...
name|CayenneMapEntry
argument_list|>
name|entityAttributeDbPathIterator
init|=
name|entityAttribute
operator|.
...
name|DbRelationship
argument_list|>
name|entityAttributeDbPathRelationships
init|=
operator|new
name|ArrayList
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// Collect DB path relationships into list
while|while
condition|(
name|entityAttributeDbPathIterator
operator|.
...
block|}
block|}
comment|// Check attribute last DB relationship target entity
if|if
condition|(
name|entityAttributeDbPathRelationships
operator|.
...
condition|)
block|{
comment|// Entity attribute last DB relationship target is flattened vertical
comment|// inheritance attribute, so add its relationships to incoming
