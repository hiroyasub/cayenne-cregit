...
begin_comment
comment|/**  * {@link Artifact} facade for an ObjEntity.  *   * @since 3.0  * @author Andrus Adamchik  */
end_comment
...
name|Artifact
block|{
comment|/**      * @deprecated since 3.0 "OBJECT" should be used instead, as the root key in the      *             template is not necessarily ObjEntity. Still preserved for ObjEntities      *             for backwards compatibility.      */
specifier|public
specifier|static
name|String
name|OBJ_ENTITY_KEY
