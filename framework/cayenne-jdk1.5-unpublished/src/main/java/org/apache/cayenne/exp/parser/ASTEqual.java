...
condition|)
block|{
comment|/**              * Per CAY-419 we perform 'in' comparison if one object is a list,              * and other is not              */
if|if
condition|(
name|o1
operator|instanceof
...
return|;
block|}
comment|/**      * Compares two objects. They must not be null      */
specifier|static
name|boolean
name|evaluateAtomic
parameter_list|(
...
parameter_list|)
block|{
comment|//try to inject value, if one of the operands is scalar, and other is a path
name|Node
index|[]
name|args
init|=
