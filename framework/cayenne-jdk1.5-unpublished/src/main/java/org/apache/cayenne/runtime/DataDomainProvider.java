...
expr_stmt|;
block|}
comment|/**      * Returns the name of DataDomain configuration resource derived from runtime name.      * Resource name is determined based on the naming convention.      * "cayenne-<runtimename>.xml".      */
specifier|protected
name|String
name|getResourceName
parameter_list|(
