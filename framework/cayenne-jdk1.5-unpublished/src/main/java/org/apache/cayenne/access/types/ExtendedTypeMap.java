...
begin_comment
comment|// TODO: andrus 10/30/2007 - implement efficient synchronization. This class is 99% read
end_comment

begin_comment
comment|// and 1% write, so probably should use ConcurrentHashMap once we switch to Java 5.
end_comment
