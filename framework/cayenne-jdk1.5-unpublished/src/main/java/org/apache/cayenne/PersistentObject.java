...
return|;
block|}
comment|/**      * Returns mapped ObjEntity for this object. If an object is transient or is not      * mapped returns null.      *       * @since 1.2      * @deprecated since 3.1 {@link org.apache.cayenne.Cayenne#getObjEntity(Persistent)} is used      */
annotation|@
name|Deprecated
specifier|public
name|ObjEntity
