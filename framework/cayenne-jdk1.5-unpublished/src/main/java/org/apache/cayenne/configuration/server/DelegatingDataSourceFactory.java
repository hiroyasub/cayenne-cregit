...
parameter_list|)
block|{
comment|// no real thread-safety here, just checking to speed up processing... in the
comment|// worst case we'll replace event binding for the same pool with an equivalent one
if|if
condition|(
operator|!
name|managedDataSources
