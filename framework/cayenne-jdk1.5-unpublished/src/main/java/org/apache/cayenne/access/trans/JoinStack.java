...
block|}
block|}
comment|/**      * Append join tree node information to the qualifier - the part after "WHERE".      * @return whether qualifier was not yet appended (i.e. firstQualifierElement is still false)      */
specifier|private
name|boolean
name|appendQualifier
parameter_list|(
