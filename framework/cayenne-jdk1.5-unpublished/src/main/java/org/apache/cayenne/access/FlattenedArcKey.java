...
condition|)
block|{
comment|// since the name of the column can potentially be quoted and use reserved
comment|// keywords as name, let's specify
comment|// generated column name parameters to ensure the query doesn't explode
name|sql
operator|.
name|append
argument_list|(
