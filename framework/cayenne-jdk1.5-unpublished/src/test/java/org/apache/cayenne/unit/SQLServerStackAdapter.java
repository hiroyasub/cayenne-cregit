...
expr_stmt|;
block|}
comment|// The code below was used with SQLServer<= 2005 to turn of autogenerated keys.
...
comment|// // see if MSSQL driver is used and turn off identity columns in this case...
comment|//
