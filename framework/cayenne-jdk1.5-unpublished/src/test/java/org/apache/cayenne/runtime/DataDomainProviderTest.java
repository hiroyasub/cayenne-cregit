...
argument_list|)
expr_stmt|;
comment|// assertNotNull(node1.getAdapter());
comment|// assertEquals(OracleAdapter.class, node1.getAdapter().getClass());
name|DataNode
name|node2
init|=
name|domain
...
argument_list|)
expr_stmt|;
comment|// assertNotNull(node2.getAdapter());
comment|// assertEquals(AutoAdapter.class, node2.getAdapter().getClass());
block|}
block|}
end_class
