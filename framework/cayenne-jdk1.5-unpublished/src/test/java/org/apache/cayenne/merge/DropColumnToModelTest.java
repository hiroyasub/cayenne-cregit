...
argument_list|)
expr_stmt|;
comment|// force drop name column in db
name|MergerToken
name|token
init|=
name|mergerFactory
...
argument_list|)
expr_stmt|;
comment|// remove relationship and fk from model, merge to db and add to model
name|dbEntity2
operator|.
...
argument_list|)
expr_stmt|;
comment|// TODO: assertTrue(dbEntity1.getRelationships().isEmpty());
name|assertTrue
argument_list|(
name|dbEntity2
operator|.
...
argument_list|)
expr_stmt|;
comment|// assertNull(objEntity.getAttribute(oatr1.getName()));
comment|// TODO: test that relationship is gone
comment|// clear up
name|DataContext
name|ctxt
init|=
