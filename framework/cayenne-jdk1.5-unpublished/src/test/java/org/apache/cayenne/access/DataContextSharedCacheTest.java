...
specifier|public
class|class
name|DataContextSharedCacheTest
extends|extends
name|MultiContextCase
block|{
specifier|protected
...
expr_stmt|;
block|}
comment|/**      * Test case to prove that refreshing snapshots as a result of the database fetch will      * be propagated accross DataContexts.      */
specifier|public
name|void
...
literal|"version2"
decl_stmt|;
comment|// create alternative context making sure that no cache is flushed
name|DataContext
name|altContext
init|=
name|context
...
expr_stmt|;
block|}
comment|/**      * Test case to prove that changes made to an object in one ObjectStore and committed      * to the database will be reflected in the peer ObjectStore using the same      * DataRowCache.      *       * @throws Exception      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Test case to prove that deleting an object in one ObjectStore and committing to the      * database will be reflected in the peer ObjectStore using the same DataRowCache. By      * default COMMITTED objects will be changed to TRANSIENT.      *       * @throws Exception      */
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// create independent context and fetch artist in it
name|DataContext
name|context3
init|=
name|getDomain
...
expr_stmt|;
block|}
comment|/**      * Test case to prove that deleting an object in one ObjectStore and committing to the      * database will be reflected in the peer ObjectStore using the same DataRowCache,      * including proper processing of deleted object being held in to-many collections.      *       * @throws Exception      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Checks that cache is not refreshed when a query "refreshingObjects" property is set      * to false.      *       * @throws Exception      */
specifier|public
name|void
name|testCacheNonRefreshingOnSelect
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Checks that cache is refreshed when a query "refreshingObjects" property is set to      * true.      *       * @throws Exception      */
specifier|public
name|void
