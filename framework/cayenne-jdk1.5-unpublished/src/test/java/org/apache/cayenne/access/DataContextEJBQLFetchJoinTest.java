...
name|createTestData
argument_list|(
literal|"testOneEntityFetchJoin"
argument_list|)
expr_stmt|;
name|String
name|ejbql
...
literal|"SELECT a "
operator|+
literal|"FROM Artist a JOIN FETCH a.paintingArray.toPaintingInfo"
decl_stmt|;
name|EJBQLQuery
name|query
init|=
...
argument_list|()
decl_stmt|;
comment|// TODO fails because of error translating of chain join relationship
comment|/*          * List objects = context.performQuery(query); blockQueries(); try { } finally {          * unblockQueries(); }          */
block|}
block|}
end_class
