...
parameter_list|()
block|{
comment|// We should have only one relationship.  ClientCompany -> CustomerRepresentative.
name|assertEquals
argument_list|(
literal|1
argument_list|,
...
comment|// ClientCompany -> AbstractPerson and ClientCompany -> CustomerRepresentative.
name|assertEquals
argument_list|(
literal|1
argument_list|,
