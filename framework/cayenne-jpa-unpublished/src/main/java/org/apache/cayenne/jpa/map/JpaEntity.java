...
expr_stmt|;
block|}
comment|/**      * Returns a child JpaInheritance object that is only set on a root of inheritance      * hierarchy.      */
annotation|@
name|TreeNodeChild
specifier|public
name|JpaInheritance
...
return|;
block|}
comment|/**      * Returns inheritance type for this entity hierarchy. If the entity has no      * inheritance settings, returns null.      */
specifier|public
name|InheritanceType
...
return|;
block|}
comment|/**      * Returns a table for this entity hierarchy.      */
specifier|public
name|JpaTable
name|lookupTable
parameter_list|()
...
return|;
block|}
comment|/**      * Returns a discriminator column for this entity hierarchy.      */
specifier|public
name|JpaDiscriminatorColumn
