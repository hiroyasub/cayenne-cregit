...
specifier|final
class|class
name|DiscriminatorColumnVisitor
extends|extends
name|BaseTreeVisitor
block|{
annotation|@
...
condition|)
block|{
comment|// no dedicated table for the single_table inheritance subclass
block|}
...
parameter_list|)
block|{
comment|// now that attributes are parsed, we can fill in secondary table joins that
comment|// may depend on previous entity id column processing.
name|JpaEntity
name|entity
init|=
operator|(
...
name|entity
argument_list|,
literal|"Can't guess default discriminator value for non-String discriminator column: "
operator|+
name|discriminator
operator|.
name|getName
