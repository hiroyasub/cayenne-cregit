...
specifier|final
name|String
name|DROP_SCHEMA_PROPERTY
init|=
literal|"org.apache.cayenne.schema.drop"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
name|jta
operator|+
literal|" DataSource returned from PersistenceUnitInfo"
argument_list|)
expr_stmt|;
block|}
name|DbAdapter
...
expr_stmt|;
block|}
comment|// TODO: add a property to generate schema per bundled or custom strategies
name|node
operator|.
...
return|;
block|}
comment|/**      * Drops database schema if it exists.      */
specifier|protected
name|void
name|dropSchema
parameter_list|(
...
name|debug
argument_list|(
literal|"did not find at least one table; will skip dropping schema."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"detected existings schema;; will continue with schema generation."
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"detected existings schema; will skip schema generation."
argument_list|)
expr_stmt|;
return|return;
block|}
...
name|debug
argument_list|(
literal|"did not find at least one table; "
operator|+
literal|"will continue with schema generation."
argument_list|)
expr_stmt|;
comment|// run generator
name|DbGenerator
...
block|}
block|}
comment|/**      * Checks that at least one table in the collection of DbEntities is present in the      * DB. Negative or unknown outcomes result in false being returned.      */
specifier|protected
name|boolean
name|existingTablesDetected
parameter_list|(
...
argument_list|(
literal|"DataNode has null DataSource"
argument_list|)
throw|;
block|}
return|return
