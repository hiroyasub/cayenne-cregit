...
literal|12
decl_stmt|;
comment|/**      * Default delete rule for one-to-many relationships. It is used when new rels are      * created via 'New' button or reverse engineering      */
specifier|public
specifier|static
specifier|final
name|int
...
name|DENY
decl_stmt|;
comment|/**      * Default delete rule for many-to-one relationships. It is used when new rels are      * created via 'New' button or reverse engineering      */
specifier|public
specifier|static
specifier|final
name|int
