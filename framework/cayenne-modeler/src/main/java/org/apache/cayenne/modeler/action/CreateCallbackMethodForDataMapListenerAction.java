...
begin_comment
comment|/**  * Action class for creating callback methods on DataMap entity listener  *  * @author Vasil Tarasevich  * @version 1.0 Oct 30, 2007  */
end_comment
...
name|ACTION_NAME
init|=
literal|"Create callback method for data map entity listener"
decl_stmt|;
