...
name|DefaultTreeModel
block|{
comment|/**      * Creates a tree of Swing TreeNodes wrapping Cayenne project object. Returns the root      * node of the tree.      *       * @deprecated since 3.1 use {@link ProjectTreeFactory}.      */
specifier|public
specifier|static
name|DefaultMutableTreeNode
