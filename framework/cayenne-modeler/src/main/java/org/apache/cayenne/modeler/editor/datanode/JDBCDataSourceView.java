...
argument_list|)
expr_stmt|;
comment|//        passwordSource.setModel(new DefaultComboBoxModel(passwordLocations));
comment|//      EntityResolver resolver = mediator.getCurrentDataDomain().getEntityResolver();
name|DefaultComboBoxModel
...
argument_list|)
decl_stmt|;
comment|//passwordSourceModel.setSelectedItem(query.getMetaData(resolver).getCachePolicy());
name|passwordLocation
operator|.
name|setModel
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//        passwordLocation.addActionListener(new ActionListener() {
comment|//          public void actionPerformed(ActionEvent event) {
comment|//              Object source = passwordLocation.getModel().getSelectedItem();
