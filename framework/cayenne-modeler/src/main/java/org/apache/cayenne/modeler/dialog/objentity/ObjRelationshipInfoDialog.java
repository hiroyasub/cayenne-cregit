...
name|FormLayout
argument_list|(
literal|"right:max(50dlu;pref), 3dlu, fill:min(150dlu;pref), 3dlu, fill:min(120dlu;pref)"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// enable disable collections when relationship semntics changes
name|relationshipCombo
operator|.
name|addActionListener
argument_list|(
