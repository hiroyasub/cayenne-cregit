...
name|treeSelectionListener
decl_stmt|;
comment|/**      * Popup menu containing basic functions      */
specifier|protected
name|JPopupMenu
name|popup
decl_stmt|;
...
block|}
block|}
comment|/**              * Converts TreePath to ProjectPath              */
specifier|private
name|ProjectPath
name|createProjectPath
parameter_list|(
...
return|;
block|}
comment|/**      * Creates and returns an menu item associated with the key.      *       * @param key action key      */
specifier|private
name|JMenuItem
name|buildMenu
parameter_list|(
...
return|;
block|}
comment|/**      * Class to handle right-click and show popup for selected tree row      */
class|class
name|PopupHandler
extends|extends
name|MouseAdapter
