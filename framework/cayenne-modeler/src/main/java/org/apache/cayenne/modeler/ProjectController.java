...
begin_comment
comment|/**  * A controller that works with the project tree, tracking selection and dispatching  * project events.  *<p>  * TODO: Refactor the event model, so that events are generic and contain "path" to a  * project node in question. After this is done, EventController should no longer maintain  * the selection model (currentXYZ ivars), rather it should update internal model.  *</p>  */
end_comment
...
name|callbackType
decl_stmt|;
comment|/**          * currently selected callback method          */
specifier|private
name|String
name|callbackMethod
decl_stmt|;
...
return|;
block|}
comment|/**      * Returns top preferences Domain for the current project, throwing an exception if no      * project is selected.      */
specifier|public
name|Domain
...
return|;
block|}
comment|/**      * @return currently selected callback method      */
specifier|public
name|String
...
expr_stmt|;
block|}
comment|/**      * adds callback type selection listener      * @param listener listener      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * adds listener class selection listener      * @param listener listener      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * adds callback method display listener      * @param listener listener      */
specifier|public
name|void
name|addCallbackMethodDisplayListener
parameter_list|(
...
block|}
block|}
comment|/**      * fires callback type selection event      * @param e event      */
specifier|public
name|void
...
block|}
block|}
comment|/**      * fires listener class selection event      * @param e event      */
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|//if (currentState.map != null&& e.getId() == MapEvent.CHANGE) {
comment|//    currentState.map.objRelationshipChanged(e);
comment|//}
name|EventListener
index|[]
name|list
...
block|}
block|}
comment|/**      * fires callback method display event event      * @param e event      */
specifier|public
name|void
