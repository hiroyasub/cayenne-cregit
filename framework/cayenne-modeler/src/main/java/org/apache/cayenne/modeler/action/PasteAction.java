...
name|content
decl_stmt|;
comment|/**                  * Change Query root do current datamap's                  */
name|Object
name|root
init|=
name|query
...
argument_list|()
argument_list|,
literal|"Query root cannot be resolved. Pasting has not been performed."
argument_list|,
literal|"Warning"
argument_list|,
name|JOptionPane
...
block|}
block|}
comment|/**      * Finds avaliable name for an object      */
specifier|private
name|String
name|getFreeName
parameter_list|(
...
parameter_list|)
block|{
comment|/**              * Name mast be unique through all DataDomain, for EntityResolver to work              * correctlys              */
for|for
control|(
name|DataMap
name|map
