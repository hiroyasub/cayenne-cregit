...
begin_comment
comment|/**  * Superclass of CayenneModeler actions that implements support for some common  * functionality, exception handling, etc.  *   * @author Andrus Adamchik  */
end_comment
...
return|;
block|}
comment|/**      * Factory method that creates a text field hooked up to this action      */
specifier|public
name|JTextField
name|buildTextField
parameter_list|()
block|{
name|CayenneTextField
name|ctf
init|=
operator|new
name|CayenneTextField
...
block|}
block|}
comment|/**      * A text field that gains focus when some predefined combonation if keys is pressed.      */
specifier|final
class|class
name|CayenneTextField
extends|extends
