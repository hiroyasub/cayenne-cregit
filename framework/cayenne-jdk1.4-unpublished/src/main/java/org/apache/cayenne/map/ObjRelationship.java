...
name|this
argument_list|,
literal|"dbRelationshipDidChange"
argument_list|,
name|RelationshipEvent
operator|.
name|class
...
expr_stmt|;
block|}
comment|// Do not listen any more
name|EventManager
operator|.
name|getDefaultManager
argument_list|()
...
expr_stmt|;
block|}
comment|/**      * Returns a property name of a target entity used to create a relationship map. Only      * has effect if collectionType property is set to "java.util.Map".      *       * @since 3.0      */
specifier|public
name|String
name|getMapKey
parameter_list|()
