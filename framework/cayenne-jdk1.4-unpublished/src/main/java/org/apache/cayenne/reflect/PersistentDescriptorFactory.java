...
return|;
block|}
comment|// do not use 'targetDescriptor' to resolve target entity, as it leads to an
comment|// endless loop during the phase when descriptos are not fully initialized
name|ObjEntity
name|targetEntity
init|=
operator|(
...
block|{
return|return
name|MultiColumnIdMapKeyAccessor
operator|.
...
block|{
return|return
name|SingleColumnIdMapKeyAccessor
operator|.
name|SHARED_ACCESSOR
return|;
block|}
