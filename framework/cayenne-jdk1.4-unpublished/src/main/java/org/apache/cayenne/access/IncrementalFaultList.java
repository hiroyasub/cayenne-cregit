...
return|;
block|}
comment|/**      * Performs initialization of the internal list of objects. Only the first page is      * fully resolved. For the rest of the list, only ObjectIds are read.      *       * @since 1.0.6      */
specifier|protected
name|void
name|fillIn
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * @param object      * @return<code>true</code> if the object corresponds to an unresolved state and      *         doesn require a fetch before being returned to the user.      */
specifier|private
name|boolean
name|isUnresolved
parameter_list|(
