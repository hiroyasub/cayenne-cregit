...
begin_comment
comment|/**  * ObjEntity is a mapping descriptor for a DataObject Java class. It contains the  * information about the Java class itself, as well as its mapping to the DbEntity layer.  *   * @author Misha Shengaout  * @author Andrus Adamchik  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Returns an ObjEntity stripped of any server-side information, such as DbEntity      * mapping. "clientClassName" property of this entity is used to intialize "className"      * property of returned entity.      *       * @since 1.2      */
specifier|public
name|ObjEntity
...
return|;
block|}
comment|/**      * Returns an unmodifiable collection of listener methods.      *       * @since 3.0      */
specifier|public
name|Collection
...
return|;
block|}
comment|/**      * Adds new listener method. If a method has no name, IllegalArgumentException is      * thrown.      *       * @since 3.0      */
specifier|public
name|void
