...
argument_list|()
decl_stmt|;
comment|// event posting default for new DataContexts
specifier|private
specifier|static
name|boolean
name|transactionEventsEnabledDefault
decl_stmt|;
comment|// enable/disable event handling for individual instances
specifier|private
name|boolean
name|transactionEventsEnabled
decl_stmt|;
...
specifier|static
name|void
name|setTransactionEventsEnabledDefault
parameter_list|(
name|boolean
name|flag
parameter_list|)
...
parameter_list|()
block|{
comment|// post event: WILL_COMMIT
if|if
condition|(
name|this
operator|.
...
parameter_list|()
block|{
comment|// post event: DID_ROLLBACK
if|if
condition|(
operator|(
name|this
