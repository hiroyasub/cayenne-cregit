...
expr_stmt|;
block|}
comment|// lookup DbEntity in EntityResolver cache to take into account all
comment|// DataMaps in the namespace
name|Object
name|dbEntity
init|=
name|dbEntityCache
