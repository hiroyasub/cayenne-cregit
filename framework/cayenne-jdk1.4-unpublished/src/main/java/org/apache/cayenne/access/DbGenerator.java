...
block|}
block|}
comment|/**      * Returns an array of queries to create foreign key constraints for a particular      * DbEntity. Throws CayenneRuntimeException, if called for adapter that does not      * support FK constraints.      */
specifier|public
name|List
name|createFkConstraintsQueries
parameter_list|(
...
name|CayenneRuntimeException
argument_list|(
literal|"FK constraints are not supported by adapter."
argument_list|)
throw|;
block|}
name|List
...
comment|// is not propagated via releationship
if|if
condition|(
name|pkAttributes
operator|.
