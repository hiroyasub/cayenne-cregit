...
decl_stmt|;
comment|/**      * Creates a new channel accessing remote server via provided connection. Channel      * created using this constructor will post no events of its own and provide its users      * with a multithreaded EventManager.      */
specifier|public
name|ClientChannel
parameter_list|(
name|ClientConnection
...
argument_list|)
decl_stmt|;
comment|// subclass descriptors will be resolved on the fly... here
comment|// find objects base descriptor.
name|ListIterator
name|it
init|=
name|objects
