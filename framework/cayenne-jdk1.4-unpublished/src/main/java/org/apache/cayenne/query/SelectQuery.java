...
expr_stmt|;
block|}
comment|/**      * Creates a SelectQuery for the specifed ObjEntity with the given qualifier      *       * @param root the ObjEntity this SelectQuery is for.      * @param qualifier an Expression indicating which objects should be fetched      */
specifier|public
name|SelectQuery
parameter_list|(
name|ObjEntity
...
expr_stmt|;
block|}
comment|/**      * Creates a SelectQuery for the specifed DbEntity.      *       * @param root the DbEntity this SelectQuery is for.      * @since 1.1      */
specifier|public
name|SelectQuery
parameter_list|(
name|DbEntity
...
expr_stmt|;
block|}
comment|/**      * Creates a SelectQuery for the specifed DbEntity with the given qualifier.      *       * @param root the DbEntity this SelectQuery is for.      * @param qualifier an Expression indicating which objects should be fetched      * @since 1.1      */
specifier|public
name|SelectQuery
parameter_list|(
name|DbEntity
...
return|;
block|}
comment|/**      * Returns<code>pageSize</code> property. Page size is a hint telling Cayenne      * QueryEngine that query result should use paging instead of reading the whole result      * in the memory.      *       * @return int      */
specifier|public
name|int
name|getPageSize
parameter_list|()
