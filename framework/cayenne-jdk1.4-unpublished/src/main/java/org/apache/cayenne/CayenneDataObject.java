...
argument_list|()
decl_stmt|;
comment|/**      * Returns a DataContext that holds this object. Object becomes assocaiated with a      * DataContext either when the object is fetched using a query, or when a new object      * is registered explicitly with a DataContext.      *       * @deprecated since 3.0 use {@link #getObjectContext()}.      */
specifier|public
name|DataContext
name|getDataContext
parameter_list|()
...
block|}
block|}
comment|/**      * Returns a map key for a given object and relationship.      *       * @since 3.0      */
specifier|protected
name|Object
name|getMapKey
parameter_list|(
...
block|}
block|}
comment|/**      * Returns this object's DataContext.      *       * @since 1.2      */
specifier|public
name|ObjectContext
name|getObjectContext
parameter_list|()
