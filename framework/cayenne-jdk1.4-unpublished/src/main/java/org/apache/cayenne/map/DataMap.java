...
return|;
block|}
comment|/**      * Prints itself as a well-formed complete XML document. In comparison,      * {@link #encodeAsXML(XMLEncoder)}stores DataMap assuming it is a part of a bigger      * document.      *       * @since 1.1      */
specifier|public
name|void
name|encodeAsXML
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// skip derived, store them after regular DbEntities
if|if
condition|(
name|dbe
operator|instanceof
...
expr_stmt|;
block|}
comment|// stores relationships of for the map of entities
specifier|private
specifier|final
name|void
name|encodeDBRelationshipsAsXML
...
expr_stmt|;
block|}
comment|/**      * Removes all stored entity listeners from the map.      *       * @since 3.0      */
specifier|public
name|void
name|clearEntityListeners
parameter_list|()
block|{
name|entityListenersMap
operator|.
...
return|;
block|}
comment|/**      * Adds a default entity listener that should be notified of certain events on all      * entities.      */
specifier|public
name|void
...
name|NullPointerException
argument_list|(
literal|"Attempt to add EntityListener with no class name."
argument_list|)
throw|;
block|}
comment|// TODO: change method signature to return replaced el and make sure the
comment|// Modeler handles it...
name|Object
name|existing
init|=
...
name|IllegalArgumentException
argument_list|(
literal|"An attempt to override listener '"
operator|+
name|listener
operator|.
name|getClassName
...
expr_stmt|;
block|}
comment|/**      * Removes an {@link EntityListener} descriptor with matching class name from entity      * listeners and default entity listeners.      *       * @since 3.0      */
specifier|public
name|void
...
return|;
block|}
comment|/**      * Returns a collection of {@link EntityListener} mappings stored in the DataMap.      *       * @since 3.0      */
specifier|public
name|Collection
...
argument_list|()
decl_stmt|;
comment|// take a copy since we're going to modifiy the entity
name|Iterator
name|rels
init|=
operator|new
