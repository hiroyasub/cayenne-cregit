...
expr_stmt|;
block|}
comment|// embeddables.... must sort explicitly.
if|if
condition|(
operator|!
name|embeddables
...
return|;
block|}
comment|/**      * Removes all {@link Embeddable} descriptors with matching class name.      *       * @since 3.0      */
specifier|public
name|void
