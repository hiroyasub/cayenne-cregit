...
expr_stmt|;
block|}
comment|/**      * Returns index.eomodeld contents as a Map.      *       * @since 1.1      */
...
block|}
block|}
comment|/**      * Performs EOModel loading.      *       * @param path A path to ".eomodeld" directory. If path doesn't end with ".eomodeld",      *            ".eomodeld" suffix is automatically assumed.      */
specifier|public
name|DataMap
name|loadEOModel
parameter_list|(
...
return|;
block|}
comment|/**      * Performs EOModel loading.      *       * @param path A path to ".eomodeld" directory. If path doesn't end with ".eomodeld",      *            ".eomodeld" suffix is automatically assumed.      * @param generateClientClass if true then loading of EOModel is java client classes      *            aware and the following processing will work with Java client class      *            settings of the EOModel.      */
specifier|public
name|DataMap
name|loadEOModel
parameter_list|(
...
condition|)
block|{
comment|// not ready to handle inheritance from abstract entities...
continue|continue;
block|}
comment|// determine DB relationship mapping...
name|Expression
name|exp
init|=
operator|new
...
name|CayenneRuntimeException
argument_list|(
literal|"One and only one entity should be mapped"
operator|+
literal|" to "
operator|+
name|lastRel
...
name|CayenneRuntimeException
argument_list|(
literal|"relationship in the path was null!"
argument_list|)
throw|;
block|}
block|}
