...
begin_comment
comment|/**  * Default MapLoader. Its responsibilities include reading DataMaps from XML files and  * saving DataMap objects back to XML.  *   * @author Misha Shengaout  * @author Andrus Adamchik  * @author Andriy Shapochka  */
end_comment
...
specifier|final
name|String
name|DB_ATTRIBUTE_REF_TAG
init|=
literal|"db-attribute-ref"
decl_stmt|;
specifier|public
specifier|static
specifier|final
...
name|SAXException
block|{
name|processStartDerivedDbAttribute
argument_list|(
name|attributes
argument_list|)
expr_stmt|;
...
name|SAXException
block|{
name|processStartDbAttributeRef
argument_list|(
name|attributes
argument_list|)
expr_stmt|;
...
name|SAXException
argument_list|(
literal|"Referenced attributes are not supported by regular DbAttributes. "
operator|+
literal|" Offending attribute name '"
operator|+
name|attrib
operator|.
name|getName
