...
expr_stmt|;
block|}
comment|/**      * Tests query creation with relationship from derived entity.      */
specifier|public
name|void
name|testCreateSqlString3
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"WHERE clause is expected: "
operator|+
name|sql
argument_list|,
name|sql
...
name|assertTrue
argument_list|(
literal|"WHERE clause must have estimated price: "
operator|+
name|sql
argument_list|,
name|sql
...
name|assertTrue
argument_list|(
literal|"GROUP BY clause is expected:"
operator|+
name|sql
argument_list|,
name|sql
...
name|assertTrue
argument_list|(
literal|"HAVING clause is expected"
argument_list|,
name|sql
operator|.
name|indexOf
...
name|assertTrue
argument_list|(
literal|"Relationship join must be in WHERE: "
operator|+
name|sql
argument_list|,
name|sql
...
name|assertTrue
argument_list|(
literal|"Qualifier for related entity must be in WHERE: "
operator|+
name|sql
argument_list|,
name|sql
