...
argument_list|)
decl_stmt|;
comment|//        List data = createDataContext().performQuery(query);
comment|//        assertEquals(1, data.size());
comment|//        assertTrue(data.get(0) instanceof Object[]);
comment|//
comment|//        Object[] row0 = (Object[]) data.get(0);
comment|//        assertEquals(new BigDecimal(1), row0[0]);
comment|//        assertEquals(new Long(3), row0[1]);
block|}
block|}
end_class
