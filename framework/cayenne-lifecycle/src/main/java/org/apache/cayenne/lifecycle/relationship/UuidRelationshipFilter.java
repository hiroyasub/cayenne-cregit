...
argument_list|()
expr_stmt|;
name|registerUuidRelationships
argument_list|(
name|channel
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// TODO: create a DI-managed chain of mapping post processors, and extract this
comment|// code to a UuidRelationshipModule. The following code in DataDomainProvider
comment|// should be in the standard chain, and this method code - in an extension
comment|// dataDomain.getEntityResolver().applyDBLayerDefaults();
comment|// dataDomain.getEntityResolver().applyObjectLayerDefaults();
name|EntityResolver
name|resolver
init|=
name|channel
