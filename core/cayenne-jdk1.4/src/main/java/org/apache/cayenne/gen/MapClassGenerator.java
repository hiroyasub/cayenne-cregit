...
return|;
block|}
comment|/**      * Initializes internal ObjEntities list. This method creates a copy of the provided      * list to allow its indepdendent modification and also filters out entities that do      * not require class generation.      */
specifier|public
name|void
name|setObjEntities
parameter_list|(
