...
expr_stmt|;
block|}
comment|/**      * Returns an unmodifiable list of DbAttributes representing the primary key of the      * table described by this DbEntity.      */
comment|// TODO: (Andrus 09/06/2005) Change to Collection ... no reason to keep as list other
comment|// than backwards compatibility
specifier|public
name|List
name|getPrimaryKey
parameter_list|()
...
return|;
block|}
comment|/**      * Overrides super to fire an AttributeEvent.      */
specifier|public
name|void
name|addAttribute
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Removes attribute from the entity, removes any relationship joins containing this      * attribute.      *       * @see org.apache.cayenne.map.Entity#removeAttribute(String)      */
specifier|public
name|void
...
comment|// then break out to finish the iterators independenly
name|prependReversedPath
argument_list|(
name|finalPath
argument_list|,
