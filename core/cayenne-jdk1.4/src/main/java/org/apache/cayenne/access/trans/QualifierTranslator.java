...
block|}
block|}
comment|/**      * Returns<code>true</code> if this translator will translate      * parent qualifier on call to<code>doTranslation</code>.      *       * @return boolean      */
specifier|public
name|boolean
name|isTranslateParentQual
parameter_list|()
...
return|;
block|}
comment|/**      * Configures translator to translate      * parent or main qualifier on call to<code>doTranslation</code>.      *       * @param translateParentQual The translateParentQual to set      */
specifier|public
name|void
