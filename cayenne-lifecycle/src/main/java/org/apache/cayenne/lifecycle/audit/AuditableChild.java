...
name|AuditableChild
block|{
comment|/**      * Returns the name of a to-one relationship from an annotated object to the "parent"      * object that should be audited when annotated object is changed.      */
name|String
name|value
parameter_list|()
default|default
