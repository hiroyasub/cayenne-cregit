...
argument_list|)
expr_stmt|;
comment|//isSelected ? FilteredIconFactory.createIcon(icon, FilteredIconFactory.FilterType.SELECTION) : icon);
name|setFont
argument_list|(
name|defaultFont
argument_list|)
...
condition|)
block|{
comment|//                    icon = FilteredIconFactory.createIcon(icon, FilteredIconFactory.FilterType.SELECTION);
block|}
name|setIcon
argument_list|(
name|icon
