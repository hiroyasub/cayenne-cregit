...
block|}
block|}
comment|// now do a pass through the tables and exclude derived
name|Iterator
name|tablesIt
init|=
name|tables
...
argument_list|()
decl_stmt|;
comment|// now do a pass through the selectable tables and reset selected status
name|Iterator
name|tablesIt
init|=
name|selectableTablesList
