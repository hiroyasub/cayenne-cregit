...
begin_comment
comment|/**  * Wizard for altering the database to match the data map.  */
end_comment
...
argument_list|,
literal|"p, 9dlu, p, 3dlu, fill:40dlu:grow"
argument_list|)
argument_list|)
decl_stmt|;
name|builder
...
return|;
block|}
comment|/*      * public JCheckBox getCreateFK() { return createFK; } public JCheckBox getCreatePK() {      * return createPK; } public JCheckBox getCreateTables() { return createTables; }      * public JCheckBox getDropPK() { return dropPK; } public JCheckBox getDropTables() {      * return dropTables; }      */
specifier|public
name|JButton
