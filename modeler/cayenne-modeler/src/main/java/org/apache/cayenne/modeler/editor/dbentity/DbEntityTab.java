...
return|return;
block|}
comment|// if entity hasn't changed, still notify PK Generator panels, as entity PK may
...
argument_list|)
expr_stmt|;
comment|// build a list consisting of non-derived entities
name|DataMap
name|map
init|=
name|mediator
...
block|}
block|}
comment|/**      * Enables or disbales form fields depending on the type of entity shown.      */
specifier|protected
name|void
name|updateState
parameter_list|(
name|boolean
name|isDerivedEntity
parameter_list|)
block|{
name|schemaLabel
operator|.
