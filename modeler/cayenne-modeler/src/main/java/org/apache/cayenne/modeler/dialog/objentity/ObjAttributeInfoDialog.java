...
expr_stmt|;
block|}
comment|// need to initialize this early, to react to the later call of the view.getTypeComboBox().setSelectedItem()
name|view
operator|.
name|getTypeComboBox
argument_list|()
...
name|String
argument_list|>
name|currentEmbeddableOverride
init|=
operator|new
name|HashMap
argument_list|<>
