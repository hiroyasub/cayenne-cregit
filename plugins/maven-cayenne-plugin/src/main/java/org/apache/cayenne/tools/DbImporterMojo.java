...
name|driver
decl_stmt|;
comment|/**      * @parameter forceDataMapCatalog="forceDataMapCatalog"  default-value="false"      */
specifier|private
name|boolean
name|forceDataMapCatalog
decl_stmt|;
comment|/**      * @parameter forceDataMapSchema="forceDataMapSchema"  default-value="false"      */
specifier|private
name|boolean
