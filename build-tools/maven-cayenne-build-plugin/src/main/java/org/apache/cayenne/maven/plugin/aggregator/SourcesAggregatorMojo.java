...
specifier|public
class|class
name|SourcesAggregatorMojo
extends|extends
name|AbstractAggregatorMojo
block|{
comment|/**      * Default location used for mojo unless overridden in ArtifactItem      *       * @parameter expression="${unpackDirectory}"      *            default-value="${project.build.directory}/aggregate/unpack-sources"      * @required      */
specifier|private
name|File
