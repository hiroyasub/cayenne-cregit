...
specifier|public
class|class
name|CayenneDataObjectSetToManyListTest
extends|extends
name|ServerCase
block|{
annotation|@
...
name|assertEquals
argument_list|(
literal|"should throw a IllegalArgumentException"
argument_list|,
name|thrown
argument_list|,
literal|true
...
name|assertEquals
argument_list|(
literal|"should throw a IllegalArgumentException, because the relName does not exist"
argument_list|,
name|thrown
argument_list|,
literal|true
...
name|assertEquals
argument_list|(
literal|"should throw a IllegalArgumentException, because the relName is an empty string"
argument_list|,
name|thrown
argument_list|,
literal|true
...
name|assertEquals
argument_list|(
literal|"should throw a IllegalArgumentException, because the relName is NULL"
argument_list|,
name|thrown
argument_list|,
literal|true
...
expr_stmt|;
block|}
comment|/** 	 * Testing if collection type is list, everything should work fine without an 	 * runtimexception 	 *  	 * @throws Exception 	 */
annotation|@
name|Test
specifier|public
name|void
