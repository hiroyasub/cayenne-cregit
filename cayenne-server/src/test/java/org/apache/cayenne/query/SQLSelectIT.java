...
specifier|public
name|void
name|test_DataRowWithTypesMapped
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testObjectArrayWithDefaultTypesReturnAndDirectivesMappedToPojo
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testObjectArrayWithCustomTypeMappedToPojo
parameter_list|()
throws|throws
name|SQLException
block|{
...
name|scalarQuery
argument_list|(
literal|"SELECT IMAGE_BLOB FROM PAINTING_INFO"
argument_list|,
name|byte
index|[]
operator|.
