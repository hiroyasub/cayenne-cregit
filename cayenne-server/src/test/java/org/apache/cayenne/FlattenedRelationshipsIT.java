...
expr_stmt|;
block|}
comment|/**      * Should be able to save/insert an object with flattened (complex) toOne relationship      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Should be able to save/insert an object with null flattened (complex) toOne relationship      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
