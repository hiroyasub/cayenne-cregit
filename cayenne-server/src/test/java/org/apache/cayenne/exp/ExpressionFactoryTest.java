...
specifier|public
name|void
name|testExpWithTheSameAliasToDiffSegments
parameter_list|()
block|{
name|ExpressionFactory
operator|.
name|exp
argument_list|(
literal|"paintings#p1.gallery#p1.name = 'Test'"
argument_list|)
expr_stmt|;
block|}
comment|// CAY-2081
