...
specifier|public
name|void
name|testRemoveFKColumnWithoutRelationshipInDb
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// force drop fk column in db
name|execute
argument_list|(
name|mergerFactory
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// create db relationships, but do not sync them to db
name|DbRelationship
name|rel1To2
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// try do use the merger to remove the column and relationship in the model
name|List
argument_list|<
name|MergerToken
argument_list|>
