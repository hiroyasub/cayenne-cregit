...
specifier|final
name|String
name|CONNECTION_DB_VERSION
init|=
literal|"cayenneTestDbVersion"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|connectionInfo
operator|=
name|checkTestContainersDataSource
argument_list|(
name|connectionKey
argument_list|)
expr_stmt|;
...
parameter_list|)
block|{
comment|// special case for the testcontainers profile
if|if
condition|(
operator|!
name|connectionKey
...
argument_list|)
decl_stmt|;
comment|// no overrides, do nothing
if|if
condition|(
name|adapter
operator|==
