...
return|;
block|}
comment|/**      * SqlServer actually supports case sensitivity, but it depends on server/session/table settings,      * so we just skip this for tests stability.      *      * @return false      */
annotation|@
name|Override
specifier|public
name|boolean
