...
block|,
literal|"annotation/datamapAnnotation.map.xml"
block|}
decl_stmt|;
...
name|String
argument_list|>
name|EXTRA_EXCLUDED_FOR_NO_NATIVE_JSON
init|=
name|Set
operator|.
name|of
...
parameter_list|)
block|{
comment|// exclude various unsupported tests...
name|boolean
name|excludeLOB
init|=
operator|!
...
block|}
block|}
comment|// check for native json type
if|if
condition|(
name|excludeNativeJson
condition|)
