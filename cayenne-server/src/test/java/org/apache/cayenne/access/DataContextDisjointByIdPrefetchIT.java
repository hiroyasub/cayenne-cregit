...
literal|"SELECT "
operator|+
literal|"#result('ESTIMATED_PRICE' 'BigDecimal'), "
operator|+
literal|"#result('PAINTING_TITLE' 'String'), "
operator|+
literal|"#result('PAINTING_DESCRIPTION' 'String'), "
operator|+
literal|"#result('GALLERY_ID' 'int'), "
operator|+
literal|"#result('PAINTING_ID' 'int'), "
operator|+
literal|"#result('ARTIST_ID' 'int') "
operator|+
literal|"FROM PAINTING"
argument_list|)
operator|.
name|addPrefetch
argument_list|(
