...
specifier|public
name|void
name|testBigDecimal_Decimal
parameter_list|()
block|{
comment|// this matches the column scale exactly
name|BigDecimal
name|v1
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// this has lower scale than the column
name|BigDecimal
name|v2
init|=
operator|new
...
name|assertEquals
argument_list|(
literal|"Commit was not expected. The difference is purely in value padding"
argument_list|,
literal|2
argument_list|,
name|commitStats
