...
name|version
decl_stmt|;
comment|/** 	 * @param dataNode current data node 	 * @since 4.0 	 */
specifier|public
name|SQLServerActionBuilder
parameter_list|(
name|DataNode
...
expr_stmt|;
block|}
comment|/** 	 * @param dataNode current data node 	 * @param version database server version 	 * @since 4.2 	 */
specifier|public
name|SQLServerActionBuilder
parameter_list|(
name|DataNode
