...
argument_list|)
expr_stmt|;
comment|// register non-default types for the dates, see CAY-2691
name|map
operator|.
name|registerType
argument_list|(
...
expr_stmt|;
block|}
comment|// driver reports column size that we should "translate" to the column precision
comment|// see CAY-2694 for details
if|if
condition|(
name|type
operator|==
