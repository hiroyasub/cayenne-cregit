...
name|ParseException
block|{
comment|/*@bgen(jjtree) CustomOperator */
...
block|}
block|}
comment|// this rule returns single token that could be used as a path definition
specifier|final
specifier|public
name|Token
name|pathToken
