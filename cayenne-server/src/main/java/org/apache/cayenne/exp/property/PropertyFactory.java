...
return|;
block|}
comment|/**      * Create property that represents embeddable      *      * @param name of the property, will be used as value for path expression      * @param embeddableType type of represented embeddable entity      * @param<T> type of represented embeddable entity      * @return new path property      */
specifier|public
specifier|static
parameter_list|<
name|T
...
return|;
block|}
comment|/**      * Create property that represents embeddable      *      * @param name of the property, will be used as value for path expression      * @param exp that property will use      * @param embeddableType type of represented embeddable entity      * @param<T> type of represented embeddable entity      * @return new path property      */
specifier|public
specifier|static
parameter_list|<
name|T
