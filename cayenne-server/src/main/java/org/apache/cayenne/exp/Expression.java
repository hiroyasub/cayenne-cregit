...
name|type
decl_stmt|;
comment|/** 	 * Parses string, converting it to Expression. If string does not represent 	 * a semantically correct expression, an ExpressionException is thrown. 	 *  	 * @since 1.1 	 * @deprecated since 3.2 use {@link ExpressionFactory#exp(String)} 	 */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
parameter_list|)
block|{
name|PositionalParamTransformer
name|transformer
init|=
operator|new
name|PositionalParamTransformer
