...
begin_comment
comment|/**  *<p>  * A property in a DataObject.  *</p>  *<p>  * Used to construct Expressions quickly and with type-safety, and to construct Orderings  *</p>  *<p>  * Instances of this class are immutable  * Construct via factory methods Property.create(..)  *</p>  *  * @param<E> The type this property returns.  *  * @see Property#create(String, Class)  * @see Property#create(Expression, Class)  * @see Property#create(String, Expression, Class)  *  * @since 4.0  */
end_comment
...
name|name
decl_stmt|;
comment|/**      * Expression provider for the property      * @since 4.0      */
specifier|private
specifier|final
name|ExpressionProvider
name|expressionProvider
decl_stmt|;
comment|/**      * Explicit type of the property      * @since 4.0      */
specifier|private
specifier|final
name|Class
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Constructs a new property with the given name and expression      *      * @param name of the property (will be used as alias for the expression)      * @param expression expression for property      * @param type of the property      * @since 4.0      *      * @see Property#create(String, Expression, Class)      */
specifier|protected
name|Property
parameter_list|(
specifier|final
...
return|;
block|}
comment|/**      * @since 4.0      * @return alias for this property      */
specifier|public
name|String
name|getAlias
parameter_list|()
