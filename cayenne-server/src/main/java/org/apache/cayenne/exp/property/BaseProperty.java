...
literal|"unchecked"
block|,
literal|"Convert2Lambda"
block|,
literal|"Anonymous2MethodRef"
block|}
argument_list|)
specifier|protected
name|BaseProperty
...
name|name
expr_stmt|;
comment|// can't use lambda here, see CAY-2635
if|if
condition|(
name|expression
operator|==
...
return|;
block|}
comment|/**      * @return An expression for using operator with first argument equals to<b>this</b> property      *      and provided additional arguments      */
specifier|public
parameter_list|<
name|T
parameter_list|>
