...
begin_comment
comment|/**  * Property that represents to-many relationship mapped on {@link List}.  *<pre>{@code  * ObjectSelect.query(Artist.class)  *      .where(Artist.PAINTING_ARRAY.contains(painting));  * }</pre>  *  * @see org.apache.cayenne.exp.property  * @since 4.2  */
end_comment
