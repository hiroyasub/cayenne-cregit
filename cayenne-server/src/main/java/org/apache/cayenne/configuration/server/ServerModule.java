...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link DataChannelFilter}'s that allows downstream modules to      * "contribute" their own DataDomain filters      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for DataChannelFilter.      * @since 4.0      */
specifier|public
specifier|static
name|ListBuilder
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Creates a ServerModule with at least one configuration location. For multi-module projects additional locations      * can be specified as well.      *      * @deprecated since 4.0 use {@link ServerRuntimeBuilder#addConfig(String)} and/or      * {@link ServerModule#contributeProjectLocations(Binder)} to specify locations.      */
annotation|@
name|Deprecated
specifier|public
name|ServerModule
