...
literal|10000
decl_stmt|;
comment|/**      * Returns an extender object that allows the app to customize the ServerModule services.      *      * @since 5.0      */
specifier|public
specifier|static
...
return|;
block|}
comment|/**      * Sets transaction management to either external or internal transactions. Default is internally-managed transactions.      *      * @param binder      DI binder passed to the module during injector startup.      * @param useExternal whether external (true) or internal (false) transaction management should be used.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
expr_stmt|;
block|}
comment|/**      * Sets max size of snapshot cache, in pre 4.0 version this was set in the Modeler.      *      * @param binder DI binder passed to the module during injector startup.      * @param size   max size of snapshot cache      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
expr_stmt|;
block|}
comment|/**      * Provides access to a DI collection builder for String locations that allows downstream modules to      * "contribute" their own Cayenne project locations.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for String locations.      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link DataChannelQueryFilter}'s that allows downstream modules to      * "contribute" their own DataDomain query filters      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for DataChannelQueryFilter.      * @since 4.1      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link DataChannelSyncFilter}'s that allows downstream modules to      * "contribute" their own DataDomain sync filters      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for DataChannelSyncFilter.      * @since 4.1      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for lifecycle events listeners.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for listener Objects.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link DbAdapterDetector}'s that allows downstream modules to      * "contribute" their own adapter detectors.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for DbAdapterDetectors.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI map builder for {@link PkGenerator}'s that allows downstream modules to      * "contribute" their own pk generators.      *      * @param binder DI binder passed to the module during injector startup.      * @return MapBuilder for properties.      * @since 4.1      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI map builder for runtime properties that allows downstream modules to      * "contribute" their own properties.      *      * @param binder DI binder passed to the module during injector startup.      * @return MapBuilder for properties.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link ExtendedTypeFactory}'s that allows downstream modules to      * "contribute" their own factories.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for ExtendedTypes.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for {@link ExtendedType}'s that allows downstream modules to "contribute"      * their own types. Unlike "default" types, "user" types are loaded      * after the adapter-provided types and can override those.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for ExtendedTypes.      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
return|;
block|}
comment|/**      * @param binder DI binder passed to module during injector startup      * @return ListBuilder for user-contributed ValueObjectTypes      * @since 4.0      * @deprecated in favor of {@link #extend(Binder)} API      */
annotation|@
name|Deprecated
argument_list|(
name|since
...
argument_list|()
comment|// global stack properties
operator|.
name|setProperty
argument_list|(
name|Constants
...
literal|"false"
argument_list|)
comment|// known DbAdapter detectors in reverse order of popularity.
operator|.
...
name|class
argument_list|)
comment|//  PkGenerators for the known DbAdapters
operator|.
name|addPkGenerator
argument_list|(
name|DB2Adapter
...
argument_list|()
argument_list|)
comment|// TODO: this one should be converted from ExtendedType to ValueType
operator|.
name|addDefaultExtendedType
argument_list|(
operator|new
