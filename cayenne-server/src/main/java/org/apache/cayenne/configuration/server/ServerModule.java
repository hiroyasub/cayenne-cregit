...
decl_stmt|;
comment|/**      * Provides access to a DI collection builder for default adapter-agnostic {@link ExtendedType}'s.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for ExtendedTypes.      * @since 4.0      */
specifier|public
specifier|static
name|ListBuilder
argument_list|<
...
return|;
block|}
comment|/**      * Provides access to a DI collection builder for user-provided {@link ExtendedType}'s.      *      * @param binder DI binder passed to the module during injector startup.      * @return ListBuilder for ExtendedTypes.      * @since 4.0      */
specifier|public
specifier|static
name|ListBuilder
argument_list|<
