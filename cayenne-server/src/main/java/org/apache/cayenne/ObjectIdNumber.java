...
begin_comment
comment|/**  * Optimized implementation of {@link ObjectId} for single numeric PK  * @since 4.2  */
end_comment
...
decl_stmt|;
comment|// this two fields can be kept somewhere else as ID index shared by all IDs
specifier|private
specifier|final
name|String
name|entityName
