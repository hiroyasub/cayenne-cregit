...
return|;
block|}
comment|/** 	 * Sets new query HAVING qualifier. 	 * @since 4.0 	 */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/** 	 * Returns query HAVING qualifier. 	 * @since 4.0 	 */
specifier|public
name|Expression
...
return|;
block|}
comment|/** 	 * Adds specified HAVING qualifier to the existing HAVING qualifier joining it using "AND". 	 * @since 4.0 	 */
specifier|public
name|void
name|andHavingQualifier
parameter_list|(
name|Expression
name|e
parameter_list|)
...
expr_stmt|;
block|}
comment|/** 	 * Adds specified HAVING qualifier to the existing HAVING qualifier joining it using "OR". 	 * @since 4.0 	 */
specifier|public
name|void
name|orHavingQualifier
parameter_list|(
name|Expression
name|e
parameter_list|)
