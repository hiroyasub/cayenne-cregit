...
return|;
block|}
comment|/**      * @since 3.0      * @deprecated since 4.0, use {@link CacheableQuery#setCacheGroup(String)}      */
annotation|@
name|Deprecated
specifier|public
name|void
...
name|warn
argument_list|(
literal|"Multiple cache groups usage have been deprecated, only first one will be used."
argument_list|)
expr_stmt|;
block|}
block|}
