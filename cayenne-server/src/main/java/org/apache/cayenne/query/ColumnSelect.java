...
return|;
block|}
comment|/**      *<p>Select average value of property</p>      * @see ColumnSelect#columns(Property[])      * @deprecated since 4.2 use {@link #avg(NumericProperty)}      */
annotation|@
name|Deprecated
specifier|public
name|ColumnSelect
...
return|;
block|}
comment|/**      *<p>Select sum of values</p>      * @see ColumnSelect#columns(Property[])      * @deprecated since 4.2 use {@link #sum(NumericProperty)}      */
annotation|@
name|Deprecated
specifier|public
parameter_list|<
...
return|;
block|}
comment|/**      * Wrap result to given class.  Wrapper class should be public and have public constructor with no args.      * Columns order in the query should corespond to fields defined in that class.      *      * @param mapper function that maps result to required form.      * @since 4.2      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
