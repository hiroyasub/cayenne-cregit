...
return|;
block|}
comment|/**      * @param filters      * @param dbPath      * @param types      * @return Map<TableName, DbEntity>      * @throws SQLException      */
specifier|private
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/**      * Loads dbEntities for the specified tables.      *  @param map    DataMap to be populated with DbEntities.      * @param config      * @param tables The list of org.apache.cayenne.ashwood.dbutil.Table objects      */
specifier|public
name|List
argument_list|<
name|DbEntity
