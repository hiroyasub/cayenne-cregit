...
block|}
block|}
comment|/** 	 * Creates column descriptors based on compiled statement and query metadata 	 */
specifier|private
name|ColumnDescriptor
index|[]
name|createColumnDescriptors
parameter_list|(
name|SQLStatement
name|compiled
parameter_list|)
...
name|CayenneRuntimeException
argument_list|(
literal|"Caused by setting return types by directives and by parameters in query."
argument_list|)
throw|;
block|}
else|else
...
block|}
block|}
comment|// check explicitly set column types
if|if
condition|(
name|query
operator|.
