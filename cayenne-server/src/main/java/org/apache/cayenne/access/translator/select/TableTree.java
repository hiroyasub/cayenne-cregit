...
argument_list|)
expr_stmt|;
comment|// as we can spawn new nodes while processing existing,
comment|// we need multiple iterations until all rows are processed
name|int
name|initialSize
init|=
literal|0
...
argument_list|()
argument_list|)
comment|// copy collection in case of concurrent modification in visitor
operator|.
name|forEach
argument_list|(
name|visitor
