...
decl_stmt|;
comment|/** 	 * @since 3.1 	 * @deprecated since 4.1 this field is unused 	 */
annotation|@
name|Deprecated
specifier|protected
name|List
...
block|}
block|}
comment|/** 	 * Since 4.1 returns empty list. 	 * 	 * @since 3.1 	 * @deprecated since 4.1 use {@link #getQueryFilters()} and {@link #getSyncFilters()} 	 */
annotation|@
name|Deprecated
specifier|public
name|List
...
return|;
block|}
comment|/** 	 * Adds a new filter, immediately calling its 'init' method. Since 4.0 this 	 * method also registers passed filter as an event listener, if any of its 	 * methods have event annotations. 	 * 	 * @since 3.1 	 * @deprecated since 4.1 use {@link #addQueryFilter(DataChannelQueryFilter)} and {@link #addSyncFilter(DataChannelSyncFilter)} instead 	 */
annotation|@
name|Deprecated
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/** 	 * Removes a filter from the filter chain. 	 * 	 * @since 3.1 	 * @deprecated since 4.1 use {@link #removeQueryFilter(DataChannelQueryFilter)} and {@link #removeSyncFilter(DataChannelSyncFilter)} instead 	 */
annotation|@
name|Deprecated
specifier|public
name|void
