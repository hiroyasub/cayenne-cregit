...
throw|;
block|}
comment|// We have less objects then ids
comment|// check that we are really missing some ids and throw an exception in that case
name|StringBuilder
name|buffer
init|=
literal|null
...
block|}
block|}
comment|// we have some objects missing, throw
if|if
condition|(
name|buffer
operator|!=
...
literal|0
argument_list|,
literal|"Some ObjectIds are missing from the database. Expected "
operator|+
name|ids
operator|.
name|size
