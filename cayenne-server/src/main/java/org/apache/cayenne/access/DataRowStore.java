...
decl_stmt|;
comment|/**      * @deprecated since 4.0.M3 does nothing. Previously it used to check      * if need to create {@link EventBridge}.      */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
decl_stmt|;
comment|/**      * @deprecated since 4.0.M3 {@link DataRowStoreFactory} establishes {@link EventBridge}.      */
annotation|@
name|Deprecated
specifier|public
specifier|static
