...
block|}
block|}
comment|/** 	 * Append columns to GROUP BY clause 	 * use distinct from appendSelectColumns() method 	 * as it has some incompatible overridden versions (i.e. in Oracle translator) 	 * 	 * @since 4.0 	 */
specifier|protected
name|void
name|appendGroupByColumns
parameter_list|(
