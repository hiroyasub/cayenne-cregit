...
parameter_list|()
block|{
name|checkLimitAndJointPrefetch
argument_list|()
expr_stmt|;
name|DataMap
name|dataMap
...
expr_stmt|;
block|}
comment|/** 	 * Warn user in case query uses both limit and joint prefetch, as we don't support this combination. 	 */
specifier|private
name|void
name|checkLimitAndJointPrefetch
parameter_list|()
...
name|warn
argument_list|(
literal|"Query uses both limit and joint prefetch, this most probably will lead to incorrect result. "
operator|+
literal|"Either use disjointById prefetch or get full result set."
argument_list|)
expr_stmt|;
block|}
...
argument_list|)
expr_stmt|;
comment|// add PKs for flattened tables in flattened path
name|ObjRelationship
name|rel
init|=
name|property
...
argument_list|)
expr_stmt|;
comment|// append path PK attributes
for|for
control|(
name|DbAttribute
name|dba
