...
block|}
block|}
comment|// warn about a potentially faulty joint prefetch + limit combination
if|if
condition|(
name|warnPrefetchWithLimit
condition|)
...
name|warn
argument_list|(
literal|"The query uses both limit/offset and a joint prefetch, this most probably will lead to an incorrect result. "
operator|+
literal|"Either use disjointById prefetch or get a full result set."
argument_list|)
expr_stmt|;
block|}
block|}
