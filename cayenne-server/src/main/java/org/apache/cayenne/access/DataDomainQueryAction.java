...
operator|=
operator|new
name|IdentityConversionStrategy
argument_list|()
expr_stmt|;
block|}
else|else
...
operator|=
operator|new
name|SingleEmbeddableConversionStrategy
argument_list|()
expr_stmt|;
block|}
else|else
...
argument_list|)
expr_stmt|;
comment|// rewind response after firstList() call
name|response
operator|.
name|reset
argument_list|()
...
name|CayenneRuntimeException
argument_list|(
literal|"Unable create Embeddable class %s"
argument_list|,
name|e
argument_list|,
name|embeddable
...
name|CayenneRuntimeException
argument_list|(
literal|"Unable create instance of Embeddable %s"
argument_list|,
name|e
argument_list|,
name|embeddable
...
argument_list|()
decl_stmt|;
comment|// no conversions needed for scalar positions;
comment|// reuse Object[]'s to fill them with resolved objects
name|List
argument_list|<
name|PrefetchProcessorNode
argument_list|>
...
block|}
block|}
comment|/**      * Conversion strategy that uses mapper function to map raw result      */
specifier|private
class|class
name|MapperConversionStrategy
extends|extends
