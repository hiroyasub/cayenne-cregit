...
literal|0
decl_stmt|;
comment|// log.debug("number of triplets = " + numberTriplets);
for|for
control|(
name|i
operator|=
...
index|]
expr_stmt|;
comment|// log.debug("b1= " + b1 +", b2= " + b2 + ", b3= " + b3);
name|l
operator|=
operator|(
name|byte
...
index|]
expr_stmt|;
comment|// log.debug( "val2 = " + val2 );
comment|// log.debug( "k4 = " + (k<<4) );
comment|// log.debug( "vak = " + (val2 | (k<<4)) );
name|encodedData
index|[
name|encodedIndex
operator|+
...
operator|)
expr_stmt|;
comment|// log.debug("b1=" + b1);
comment|// log.debug("b1<<2 = " + (b1>>2) );
name|byte
name|val1
init|=
operator|(
