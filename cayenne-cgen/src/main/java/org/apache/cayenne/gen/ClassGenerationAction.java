...
return|;
block|}
comment|/** 	 * Sets an optional shared nVelocityContext. Useful with tools like VPP that 	 * can set custom values in the context, not known to Cayenne. 	 */
specifier|public
name|void
name|setContext
parameter_list|(
